# 小王子 Agent Windows Release Flow
...
- Uninstall clears `%APPDATA%\小王子 Agent`
...
- `D:\claude\LittlePrinceAgent\dist\小王子 Agent Setup 0.1.1.exe`
- `D:\claude\LittlePrinceAgent\dist\latest.yml`

## Local Verification Checklist

1. Install `小王子 Agent Setup 0.1.1.exe`.
...
- GitHub Release asset: `小王子 Agent Setup 0.1.1.exe`
- GitHub Release asset: `latest.yml`
- GitHub Release asset: `小王子 Agent Setup 0.1.1.exe.blockmap`
